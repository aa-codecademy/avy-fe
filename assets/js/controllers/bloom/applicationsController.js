...
export default async function applicationsController() {
    try {
                ...
                <div class="container mx-auto px-4">
                    <div class="fade-in">
                        <div class="mb-8">
                            ...
                            <p class="text-gray-600">${t('applications.title')}</p>
                        </div>
                            ...
                            <div class="lg:col-span-3">
                                <div class="flex justify-between items-center mb-4">
                                    <p class="text-gray-600">
                                        <span id="applicationCount">${allApplications.length}</span> ${t('applications.status')}
                                    </p>
                                    <div class="flex gap-2">
                                        <button id="viewAllBtn" class="btn btn-secondary" style="padding: 0.5rem 1rem;">
                                            <i class="fas fa-eye mr-1"></i> ${t('dashboard.viewAll')}
                                        </button>
                                        <select id="sortBy" class="form-input w-auto">
                                            ...
                                            <option value="company">${t('applications.company')} A-Z</option>
                                ...
                                <div id="emptyState" class="hidden text-center py-20">
                                    ...
                                    <h3 class="text-2xl font-bold text-gray-600 mb-2">${t('applications.noApplications')}</h3>
                                    <p class="text-gray-500">${t('messages.noData')}</p>
                                    <button onclick="window.router.navigate('/jobs')" class="btn btn-primary mt-4">
                                        ${t('nav.jobs')}
                                    </button>
                                </div>
                            </div>
        ...
        showToast(languageService.translate('messages.error'), 'error');
        window.router.navigate('/dashboard');
    }
}
